//
//  HTMIWorkFlowInputType200Strategy.m
//  MXClient
//
...
@implementation HTMIWorkFlowInputType200Strategy
...
- (HTMIFormBaseView *)getFieldItemView {
    ...
    return [[HTMIFormTextFieldView alloc] init];
}
...
- (CGFloat)getFieldItemViewHeight {
    ...
    if ((![self.fieldItemModel.modeString isEqual:[NSNull null]] && [self.fieldItemModel.modeString isEqualToString:@"1"])) {
        ...
        if (self.self.tabFormModel.tabStyle == 1 && self.fieldItemModel.scheduleFormNetWorkStyle) {
