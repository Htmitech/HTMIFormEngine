//
//  HTMIWorkFlowInputType102Strategy.m
//  MXClient
//
...
@implementation HTMIWorkFlowInputType102Strategy
...
- (HTMIFormBaseView *)getFieldItemView {
    ...
    return [[HTMIFormTextView alloc] init];
}
...
- (CGFloat)getFieldItemViewHeight {
    ...
    if (self.tabFormModel.tabStyle == 0) {
        ...
        CGFloat valueHeight = [NSString labelSizeWithMaxWidth:self.fieldItemModel.finalItemWidth-40 content:self.fieldItemModel.finalValueString FontOfSize:self.fieldItemModel.formLabelFont+2].height+26;
