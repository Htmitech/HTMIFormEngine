//
//  HTMIWorkFlowInputType7001Strategy.m
//  MXClient
//  
...
@implementation HTMIWorkFlowInputType7001Strategy
...
- (HTMIFormBaseView *)getFieldItemView {
    ...
    return [[HTMIFormGpsView alloc] init];
}
...
- (CGFloat)getFieldItemViewHeight {
    ...
    if (self.tabFormModel.tabStyle == 1 && self.fieldItemModel.scheduleFormNetWorkStyle && !(![self.fieldItemModel.modeString isEqual:[NSNull null]] && [self.fieldItemModel.modeString isEqualToString:@"1"])) {
